...
export async function parseSpreadsheetFile(file: File): Promise<{ rows: RawRow[]; columns: string[] }> {
...
export async function parseSpreadsheetUrl(url: string): Promise<{ rows: RawRow[]; columns: string[] }> {
